...
<?php $this->section("title") ?>
    <title>JMS - Candidate Inquiry</title>
<?php $this->endSection() ?>

<?php $this->section("content") ?>
    <div id="container" style="padding: 0 50px 50px 50px;">
        <div class="searchbox">
            <div class="page-title"><b>Candidate Inquiry</b></div>
    ...
    <script>
        ...
        function AJAX_get_candidate_inquiries(filter){
            if(filter == ""){
                $.ajax({
                    "url": API_URL + "get_candidate_inquiries",
                    "method": "GET",
                ...
                $.ajax({
                    "url": API_URL + "get_candidate_inquiries?" + filter,
                    "method": "GET",
                    "success": function(data){
                        createTable(data);
                    },
        ...
        function search_filter(){
            ...
            AJAX_get_candidate_inquiries(filter);
        }
    </script>
<?php $this->endSection() ?>