...
<?php $this->section("title") ?>
    <title>JMS - Candidate</title>
<?php $this->endSection() ?>

<?php $this->section("content") ?>
    <div style="padding: 0 50px 50px 50px;">
        <div class="searchbox">
            <div class="page-title"><b>Candidate</b></div>
    ...
    <script>
        ...
        function AJAX_get_candidates(filter){
            if(filter == ""){
                $.ajax({
                ...
                $.ajax({
                    "url": API_URL + "get_candidates?" + filter,
                    "method": "GET",
                    "success": function(data){
                        createTable(data);
                        createTable(data);
