...
<?php $this->section("content") ?>
    <link rel="stylesheet" href="<?= base_url("css/employer/update_job.css") ?>">
    ...
    <section class="section-1">
           ...
           <div class="container ">  
            ...
            <div style="background-color: yellowgreen; width: 100%; height: 60px; border-radius: 15px;" ></div>
                ...
                <div style="font-size: 2.5em; text-align: center; margin-top: -55px; margin-bottom: 30px;">Update Job</div>
          ...
          ?>
                ...
                <div class="form-group">
                    <table class="table" >     
                     <td><input type="text" name="job-title" placeholder="Title" class="form-control name_list" style="width: 73%;"  value="<?= $job["TITLE"] ?>" /></td>
                   </table>  
                </div>
                ...
                <div class="form-group">
                    <table class="table" >     
                     <td><input type="text" name="job-title" placeholder="Type" class="form-control name_list" style="width: 73%;" value="<?= $job["TYPE"] ?>" /></td>
                   </table>  
                </div>
                ...
                <div class="form-group">
                    <table class="table" >     
                     <td><input type="text" name="job-title" placeholder="Salary" class="form-control name_list" style="width: 73%;" value="<?= $job["SALARY"] ?>" /></td>
                   </table>  
                </div>
                ...
                <div class="form-group">
                    <table class="table" >     
                     <td><input type="text" name="job-title" placeholder="Career Level" class="form-control name_list" style="width: 73%;" value="<?= $job["CAREER_LEVEL"] ?>" /></td>
                   </table>  
                </div>
                ...
                <div class="form-group">  
                          ...
                          <div class="table-responsive">  
                               <table class="table" id="requirement_field">  
                                    <tr>  
                                         <td><input type="text" name="requirement" placeholder="Requirement 1" class="form-control name_list" value="<?= $job["REQUIREMENT"] ?>" /></td>  
                ...
                <div class="form-group">  
                          <div class="table-responsive">  
                               <table class="table " id="specialization_field">  
                                    <tr>  
                                         <td><input type="text" name="specialization" placeholder="Specialization 1" class="form-control name_list" value="<?= $job["SPECIALIZATION"] ?>" /></td>  
                ...
                <div class="form-group">  
                          <div class="table-responsive">  
                               <table class="table " id="qualification_field">  
                                    <tr>  
                                         <td><input type="text" name="qualification" placeholder="Qualification 1" class="form-control name_list" value="<?= $job["QUALIFICATION"] ?>" /></td>  
                ...
                <div class="form-group">  
                          <div class="table-responsive">  
                               <table class="table " id="description_field">  
                                         ...
                                         <td style="width: 73%;"><textarea type="text" name="description" placeholder="Description" class="form-control " style="height: 100px;"><?= $job["DESCRIPTION"] ?></textarea></td>  
                                         <td> </td>  
                ...
                <div class="form-group">  
                          <div class="table-responsive">  
                               <table class="table " id="scope_field">  
                                         ...
                                         <td style="width: 73%;"><textarea type="text" name="scope" placeholder="Scope" class="form-control " style="height: 100px;"><?= $job["SCOPE"] ?></textarea></td>  
                                         <td> </td>  
