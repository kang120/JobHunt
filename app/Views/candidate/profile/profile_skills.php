...
<?php $this->section("profile-detail") ?>
    ...
    <form id="add-profile-form" class="add-profile-form add-education-form" action="<?= base_url("/candidate/profile/skills") ?>" method="POST">
        <table width="100%">
            <col width="25%">
            <col width="75%">
            <tr>
            ...
            <tr>
                <td><label>Proficiency (1-10)</label></td>
